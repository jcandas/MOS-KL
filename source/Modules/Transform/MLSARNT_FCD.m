function [Datas, parameters] = MLSARNT_FCD(Datas, parameters, methods)
%close all

%Chooses Truncation parameter based on Absolute Relative Noise. Projects data onto
%corresponding MLS subspace. Conserves the features whose Fisher Criterion
...
if MA == length(relNoise), MA = 1;  end
end
